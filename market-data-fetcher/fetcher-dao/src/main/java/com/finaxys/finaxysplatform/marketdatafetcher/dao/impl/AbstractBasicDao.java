...
import com.finaxys.finaxysplatform.marketdatafetcher.dao.BasicDao;
import com.finaxys.finaxysplatform.marketdatafetcher.dao.exception.DataAccessException;
import com.finaxys.finaxysplatform.marketdatafetcher.dao.exception.DataAccessFixtureException;
...
//	private Put makePut(T bean) throws DataAccessFixtureException {
//		Put p = null;
//		try {
//			Assert.notNull(bean, "Cannot persist null object");
//			p = new Put(HBaseUtils.makeRowKey(bean).getKey());
//			List<Field> attributes = DaoHelper.getFields(clazz);
//			Object value;
//			for (Field attribute : attributes)
